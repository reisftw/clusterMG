...
function buildImovelPayload(body = {}, user = {}, existing = {}) {
	...
	return {
		...
		aguaValorMedio: numberValue(
			body.aguaValorMedio ??
				body.contaAguaValorMedio ??
				existing.aguaValorMedio,
		),
		aguaCodigoCliente: text(
			body.aguaCodigoCliente ??
				body.codigoClienteAgua ??
				existing.aguaCodigoCliente,
		),
