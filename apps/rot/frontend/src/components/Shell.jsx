...
const QRCODE_ITEM = { key: "qrcode", label: "Gerar QR Code", path: "/admin/qrcodes", icon: QrCode, permission: "rot.qrcodes.view" };
...
export const OPERATION_MENU_ITEMS = {
	...
	equipamentos: { label: "Equipamentos", path: "/equipamentos", icon: Cpu, permission: null },
...
const ASSETS_SECURITY_MENU_ITEMS = {
	"ativos-overview": { label: "Visão Geral", path: "/ativos-seguranca", icon: LayoutDashboard, permission: "ativos.visualizar", end: true },
	"meus-ativos": { label: "Meus Ativos", path: "/ativos-seguranca?tab=meus-ativos", icon: Boxes, permission: "ativos.visualizar" },
	...
	"inspecoes-pendentes": { label: "Inspeções Pendentes", path: "/ativos-seguranca?tab=checklists", icon: ListChecks, permission: "checklists.executar" },
	"informar-problema": { label: "Informar Problema", path: "/ativos-seguranca?tab=ocorrencias", icon: AlertTriangle, permission: "ocorrencias.criar" },
	...
	indicadores: { label: "Indicadores", path: "/ativos-seguranca?tab=indicadores", icon: BarChart3, permission: "ativos.visualizar" },
