...
export { CONSEQUENCE_OPTIONS, MAX_REQUEST_PHOTOS, MIN_REQUEST_PHOTOS, PRIORITY_BADGE, PRIORITY_OPTIONS, STATUS_BADGE, STATUS_OPTIONS, TYPE_OPTIONS, statusLabel, typeLabel };
