...
export const CARGOS_ADM = [
	...
	{ value: ROLES.ANALISTA_ADMINISTRATIVO, label: "Analista Administrativo" },
	{ value: ROLES.LIDER_EMPRESA, label: "Líder da Empresa" },
	{ value: ROLES.SUPERVISOR_EMPRESA, label: "Supervisor da Empresa" },
	{ value: ROLES.AGENTE_AUTORIZADO, label: "Agente Autorizado" },
	{ value: ROLES.VISITANTE, label: "Visitante" },
];
...
export const ROLE_VALUES = Object.freeze(
	CARGOS_ADM.map((cargo) => cargo.value),
);

export const ROLE_LABELS = Object.freeze(
	Object.fromEntries(
		CARGOS_ADM.map((cargo) => [cargo.value, cargo.label]),
	),
);
...
export const PERMISSION_LABELS = Object.freeze({
	...
	"facilities.dashboard.view": "Facilities - Visão Geral",
	"facilities.imoveis_espacos.view": "Facilities - Imóveis & Espaços",
	"facilities.imoveis.view": "Facilities - Imóveis - Visualizar",
	"facilities.imoveis.create": "Facilities - Imóveis - Criar",
	"facilities.imoveis.edit": "Facilities - Imóveis - Editar",
	"facilities.imoveis.deactivate": "Facilities - Imóveis - Inativar",
	"facilities.patrimonio_inventario.view": "Facilities - Patrimônio & Inventário",
	"facilities.patrimonio.view": "Facilities - Patrimônio - Visualizar",
	"facilities.patrimonio.create": "Facilities - Patrimônio - Criar",
	"facilities.patrimonio.edit": "Facilities - Patrimônio - Editar",
	"facilities.patrimonio.transfer": "Facilities - Patrimônio - Transferir",
	"facilities.patrimonio.deactivate": "Facilities - Patrimônio - Inativar",
	"facilities.patrimonio.qr.export": "Facilities - Patrimônio - Exportar QR",
	"facilities.inventario.view": "Facilities - Inventário - Visualizar",
	"facilities.inventario.execute": "Facilities - Inventário - Executar",
	"facilities.inventario.approve": "Facilities - Inventário - Aprovar",
	"facilities.acessos_chaves.view": "Facilities - Acessos & Chaves",
	"facilities.chaves.view": "Facilities - Chaves - Visualizar",
	"facilities.chaves.create": "Facilities - Chaves - Criar",
	"facilities.chaves.edit": "Facilities - Chaves - Editar",
	"facilities.chaves.checkout": "Facilities - Chaves - Retirar",
	"facilities.chaves.return": "Facilities - Chaves - Devolver",
	"facilities.chaves.declare_lost": "Facilities - Chaves - Declarar perda",
	"facilities.chaves.deactivate": "Facilities - Chaves - Inativar",
	"facilities.chaves.qr.generate": "Facilities - Chaves - Gerar QR",
	"facilities.chaves.qr.export": "Facilities - Chaves - Exportar QR",
	"facilities.operacao_predial.view": "Facilities - Operação Predial",
	"facilities.operacao_predial.manage": "Facilities - Operação Predial - Gerenciar",
	"facilities.seguranca_conformidade.view": "Facilities - Segurança & Conformidade",
	"facilities.seguranca.view": "Facilities - Segurança - Visualizar",
	"facilities.seguranca.create": "Facilities - Segurança - Criar",
	"facilities.seguranca.edit": "Facilities - Segurança - Editar",
	"facilities.seguranca.inspect": "Facilities - Segurança - Inspecionar",
	"facilities.seguranca.deactivate": "Facilities - Segurança - Inativar",
	"facilities.fornecedores_contratos.view": "Facilities - Fornecedores & Contratos",
	"facilities.fornecedores.view": "Facilities - Fornecedores - Visualizar",
	"facilities.fornecedores.manage": "Facilities - Fornecedores - Gerenciar",
	"facilities.contratos.view": "Facilities - Contratos - Visualizar",
	"facilities.contratos.manage": "Facilities - Contratos - Gerenciar",
	"facilities.consumos.view": "Facilities - Consumos",
	"facilities.consumos.create": "Facilities - Consumos - Criar",
	"facilities.consumos.edit": "Facilities - Consumos - Editar",
	"facilities.score.view": "Facilities - Saúde das Unidades",
	"facilities.saude.view": "Facilities - Saúde das Unidades - Visualizar",
	"facilities.saude.configure": "Facilities - Saúde das Unidades - Configurar",
	"facilities.relatorios.view": "Facilities - Relatórios",
	"facilities.manage": "Gerenciar Facilities",
	"administrativo.auditoria.view": "Administração - Auditoria",
	"administrativo.email.view": "Administração - E-mail - Visualizar",
	"administrativo.email.manage": "Administração - E-mail - Gerenciar",
	...
	"configuracao.auditoria.view": "Logs de Auditoria",
...
const CATALOG_TO_LEGACY_PERMISSION = Object.freeze({
	...
	"facilities.dashboard.view": "view_imoveis_administrativos",
	"facilities.imoveis_espacos.view": "view_imoveis_administrativos",
	"facilities.imoveis.view": "view_imoveis_administrativos",
	"facilities.imoveis.create": "manage_imoveis_administrativos",
	"facilities.imoveis.edit": "manage_imoveis_administrativos",
	"facilities.imoveis.deactivate": "manage_imoveis_administrativos",
	"facilities.patrimonio_inventario.view": "facilities.patrimonio_inventario.view",
	"facilities.patrimonio.view": "facilities.patrimonio_inventario.view",
	"facilities.patrimonio.create": "manage_imoveis_administrativos",
	"facilities.patrimonio.edit": "manage_imoveis_administrativos",
	"facilities.patrimonio.transfer": "manage_imoveis_administrativos",
	"facilities.patrimonio.deactivate": "manage_imoveis_administrativos",
	"facilities.patrimonio.qr.export": "facilities.patrimonio_inventario.view",
	"facilities.inventario.view": "facilities.patrimonio_inventario.view",
	"facilities.inventario.execute": "manage_imoveis_administrativos",
	"facilities.inventario.approve": "manage_imoveis_administrativos",
	"facilities.acessos_chaves.view": "view_imoveis_administrativos",
	"facilities.chaves.view": "view_imoveis_administrativos",
	"facilities.chaves.create": "manage_imoveis_administrativos",
	"facilities.chaves.edit": "manage_imoveis_administrativos",
	"facilities.chaves.checkout": "manage_imoveis_administrativos",
	"facilities.chaves.return": "manage_imoveis_administrativos",
	"facilities.chaves.declare_lost": "manage_imoveis_administrativos",
	"facilities.chaves.deactivate": "manage_imoveis_administrativos",
	"facilities.chaves.qr.generate": "manage_imoveis_administrativos",
	"facilities.chaves.qr.export": "view_imoveis_administrativos",
	"facilities.operacao_predial.view": "view_imoveis_administrativos",
	"facilities.operacao_predial.manage": "manage_imoveis_administrativos",
	"facilities.seguranca_conformidade.view": "view_imoveis_administrativos",
	"facilities.seguranca.view": "view_imoveis_administrativos",
	"facilities.seguranca.create": "manage_imoveis_administrativos",
	"facilities.seguranca.edit": "manage_imoveis_administrativos",
	"facilities.seguranca.inspect": "manage_imoveis_administrativos",
	"facilities.seguranca.deactivate": "manage_imoveis_administrativos",
	"facilities.fornecedores_contratos.view": "view_imoveis_administrativos",
	"facilities.fornecedores.view": "view_imoveis_administrativos",
	"facilities.fornecedores.manage": "manage_imoveis_administrativos",
	"facilities.contratos.view": "view_imoveis_administrativos",
	"facilities.contratos.manage": "manage_imoveis_administrativos",
	"facilities.consumos.view": "view_imoveis_administrativos",
	"facilities.consumos.create": "manage_imoveis_administrativos",
	"facilities.consumos.edit": "manage_imoveis_administrativos",
	"facilities.score.view": "view_imoveis_administrativos",
	"facilities.saude.view": "view_imoveis_administrativos",
	"facilities.saude.configure": "manage_imoveis_administrativos",
	"facilities.relatorios.view": "view_imoveis_administrativos",
	"facilities.manage": "manage_imoveis_administrativos",
	...
	"configuracao.auditoria.view": null,
...
const LEGACY_ROLE_PERMISSIONS = Object.freeze({
	...
	"configuracao.auditoria.view": ADMIN_ONLY,
