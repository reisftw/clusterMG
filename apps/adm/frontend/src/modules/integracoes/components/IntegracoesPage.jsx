		...
		<section className="rounded-xl border border-blue-100 bg-white p-5 shadow-sm">
			...
			<form onSubmit={handleSubmit} className="mt-4 grid gap-3 md:grid-cols-6">
				...
				<label className="block md:col-span-3">
					...
					placeholder="Administrativo, Documentos"
					/>
...
const DEFAULT_OKTA_OAUTH = {
	...
	issuer: "",
	clientId: "",
	redirectUri: "https://adm.retiradas.tech/login",
	allowedDomains: "",
	autoProvision: false,
	defaultRole: "visitante",
};
				...
				<div className="mt-5 flex flex-wrap items-center justify-between gap-3">
					<div>
						<p className="text-xs font-semibold text-gray-500">
							...
							<strong>https://adm.retiradas.tech</strong>.
						</p>
						{googleNeedsDomain ? (
				...
				<div className="mt-5 grid gap-4 lg:grid-cols-2">
					...
					<label className="block">
						...
						<input
							...
							placeholder="https://adm.retiradas.tech/login"
							className="input-field mt-2"
						/>
					</label>
					<label className="block">
				...
				<div className="mt-5 flex flex-wrap items-center justify-between gap-3">
					<div>
						<p className="text-xs font-semibold text-gray-500">
							...
							<strong>
								{oktaOAuth.redirectUri || "https://adm.retiradas.tech/login"}
							</strong>
							.
						</p>
						{oktaNeedsDomain ? (
