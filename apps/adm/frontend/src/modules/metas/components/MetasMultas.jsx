		...
		<div className="space-y-4">
			<div className="grid grid-cols-3 gap-3">
				{[
					...
					{
						label: "Proporcao Ret/Multa",
						value: propMult > 0 ? `${propMult}x` : "—",
						...
						<table className="min-w-[680px] w-full text-sm">
							...
							<tbody>
								{multasDiarias.map((row) => {
									const rel =
										row.lancadas > 0
											? (row.retiradas / row.lancadas).toFixed(1)
											: "—";
									return (
										<tr
											key={row.dia}
										...
										>
											...
											<td className="px-4 py-2.5 text-center text-purple-600 font-semibold">
												{rel}
											</td>
										</tr>
									);
