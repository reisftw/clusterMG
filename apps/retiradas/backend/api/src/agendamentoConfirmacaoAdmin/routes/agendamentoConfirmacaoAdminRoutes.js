...
} = require("../controllers/agendamentoConfirmacaoAdminController");
...
function createAgendamentoConfirmacaoAdminRouter({
	...
	const controller = createAgendamentoConfirmacaoAdminController({
		agendamentoConfirmacao,
	});
	...
	router.post(
		...
		requireCsrfToken,
		requireAdmin,
		controller.connectEvolutionInstance,
	);
	router.post(
		...
		requireCsrfToken,
		requireAdmin,
		controller.disconnectEvolutionInstance,
	);
	router.post(
		"/evolution/webhook",
		requireAuthenticated,
		requireCsrfToken,
		requireAdmin,
		controller.configureEvolutionWebhook,
	);
	router.post(
		"/envios/:id/responsavel",
		requireAuthenticated,
		requireCsrfToken,
		requireAdmin,
		controller.assignManualResponsible,
	);
	router.get(
		"/envios",
		requireAuthenticated,
		requireFullOperation,
