...
const appPath = path.join(rootDir, "apps/retiradas/backend/api/src/app.js");
const appDir = path.dirname(appPath);
const require = createRequire(path.join(rootDir, "apps/retiradas/backend/package.json"));
