...
const dbPath = require.resolve(path.join(process.cwd(), "apps/retiradas/backend/api/src/db.js"));
...
const auditLog = require(path.join(process.cwd(), "apps/retiradas/backend/api/src/auditLog.js"));
