		...
		<>
			<div className="grid gap-4 md:grid-cols-2">
				...
				{form.tipoPlano === "S" ? (
					...
					<>
						<label htmlFor="finan-cc-orcamento-mensal" className="text-xs font-black uppercase text-slate-500">
							Orçamento mensal
							<MoneyInput
								id="finan-cc-orcamento-mensal"
						...
						<label htmlFor="finan-cc-comprometido-mes" className="text-xs font-black uppercase text-slate-500">
							Comprometido no mês
							<MoneyInput
								id="finan-cc-comprometido-mes"
