...
const FinanNotificacoesPage = lazy(() => import("./components/FinanNotificacoesPage"));
const FinanRoadmapPage = lazy(() => import("./components/FinanRoadmapPage"));
const FinanPendenciasPage = lazy(() => import("./components/FinanPendenciasPage"));
const FinanQualidadeDadosPage = lazy(() => import("./components/FinanQualidadeDadosPage"));
const FinanAnexosPage = lazy(() => import("./components/FinanAnexosPage"));
const FinanJobsPage = lazy(() => import("./components/FinanJobsPage"));
const FinanObservabilidadePage = lazy(() => import("./components/FinanObservabilidadePage"));
const FinanApiDocsPage = lazy(() => import("./components/FinanApiDocsPage"));
const FinanImportadorPage = lazy(() => import("./components/FinanImportadorPage"));
const FinanRegrasFinanceirasPage = lazy(() => import("./components/FinanRegrasFinanceirasPage"));
const FinanWebhooksPage = lazy(() => import("./components/FinanWebhooksPage"));
const FinanConciliacaoPage = lazy(() => import("./components/FinanConciliacaoPage"));
const FinanFechamentoPage = lazy(() => import("./components/FinanFechamentoPage"));
const FinanFornecedoresPage = lazy(() => import("./components/FinanFornecedoresPage"));
const FinanOrcamentoCentrosCustoPage = lazy(() => import("./components/FinanOrcamentoCentrosCustoPage"));
const FinanContratosPage = lazy(() => import("./components/FinanContratosPage"));
const FinanMetasPage = lazy(() => import("./components/FinanMetasPage"));
const FinanIndicadoresPage = lazy(() => import("./components/FinanIndicadoresPage"));
const FinanInteligenciaPage = lazy(() => import("./components/FinanInteligenciaPage"));
const FinanContasPagarPage = lazy(() => import("./components/FinanContasPagarPage"));
const FinanContasReceberPage = lazy(() => import("./components/FinanContasReceberPage"));
const FinanNotasPage = lazy(() => import("./components/FinanNotasPage"));
const FinanCaixaEntradaPage = lazy(() => import("./components/FinanCaixaEntradaPage"));
const FinanCentralDadosPage = lazy(() => import("./components/FinanCentralDadosPage"));
	...
	return (
		<Suspense fallback={<div className="finan-loading">Carregando...</div>}>
			<Routes>
				...
				<Route
					path="gestao-orcamentaria/centros-de-custo"
					element={<FinanOrcamentoCentrosCustoPage />}
				/>
				<Route
				...
				<Route path="gestao-orcamentaria/fechamento" element={<FinanFechamentoPage />} />
				<Route path="fornecedores" element={<FinanFornecedoresPage />} />
				<Route
					path="contratos"
					element={
						<RequirePermission permission="finan.contratos.view">
							<FinanContratosPage />
						</RequirePermission>
					}
				/>
				<Route path="gestao-orcamentaria/metas" element={<FinanMetasPage />} />
				<Route path="gestao-orcamentaria/indicadores" element={<FinanIndicadoresPage />} />
				<Route path="gestao-orcamentaria/inteligencia" element={<FinanInteligenciaPage />} />
				<Route
				...
				<Route
					path="contas-a-pagar"
					element={
						<RequirePermission permission="finan.contas_pagar.view">
							<FinanContasPagarPage />
						</RequirePermission>
					}
				/>
				<Route
					...
					element={
						<RequirePermission permission="finan.contas_receber.view">
							<FinanContasReceberPage />
						</RequirePermission>
					}
				/>
				...
				<Route
					path="notas"
					element={
						<RequirePermission permission="finan.notas.view">
							<FinanNotasPage />
						</RequirePermission>
					}
				/>
				<Route
					...
					element={
						<RequirePermission permission="finan.notas.view">
							<FinanCaixaEntradaPage />
						</RequirePermission>
					}
				/>
				<Route path="equipe" element={<FinanFinanceiroPage page="equipe" />} />
				<Route path="notificacoes" element={<FinanNotificacoesPage />} />
				<Route path="roteiro" element={<FinanRoadmapPage />} />
				<Route
					path="pendencias"
					element={
						<RequirePermission permission="finan.pendencias.view">
							<FinanPendenciasPage />
						</RequirePermission>
					}
				/>
				<Route
					...
					element={
						<RequirePermission permission="finan.qualidade_dados.view">
							<FinanQualidadeDadosPage />
						</RequirePermission>
					}
				/>
				<Route
					path="anexos"
					element={
						<RequirePermission permission="finan.anexos.view">
							<FinanAnexosPage />
						</RequirePermission>
					}
				/>
				...
				/>
				<Route
					path="configuracao-geral/central-de-dados"
					element={<FinanCentralDadosPage />}
				/>
				<Route
					path="configuracao-geral/jobs"
					element={
						<RequirePermission permission="finan.configuracoes.view">
							<FinanJobsPage />
						</RequirePermission>
					}
				/>
				<Route
					path="configuracao-geral/observabilidade"
					element={
						<RequirePermission permission="finan.configuracoes.view">
							<FinanObservabilidadePage />
						</RequirePermission>
					}
				/>
				<Route
					path="configuracao-geral/api-docs"
					element={
						<RequirePermission permission="finan.configuracoes.view">
							<FinanApiDocsPage />
						</RequirePermission>
				...
				/>
				<Route
					path="configuracao-geral/importador"
					element={
						<RequirePermission permission="finan.configuracoes.view">
							<FinanImportadorPage />
						</RequirePermission>
				...
				/>
				<Route
					path="configuracao-geral/regras-financeiras"
					element={
						<RequirePermission permission="finan.configuracoes.view">
							<FinanRegrasFinanceirasPage />
						</RequirePermission>
					}
				/>
				<Route
					path="configuracao-geral/webhooks"
					element={
						<RequirePermission permission="finan.configuracoes.view">
							<FinanWebhooksPage />
						</RequirePermission>
				...
				/>
				<Route
					path="configuracao-geral/conciliacao"
					element={
						<RequirePermission permission="finan.dashboard.view">
							<FinanConciliacaoPage />
						</RequirePermission>
					}
				/>
