...
export const SYSTEM_INTEGRATIONS = Object.freeze([
	{
		...
		modules: ["Administrativo", "Insumos", "Documentos"],
		syncFrequency: "manual",
		healthcheckPath: "/auth/me",
		notes:
			"Usada apenas quando algum fluxo administrativo precisar consultar dados autorizados no Playground.",
	...
	},
	{
		...
		modules: ["Empresas", "Documentos", "Contratos"],
		syncFrequency: "manual",
		healthcheckPath: "/oauth/token",
		notes:
			"Usada pelo Administrativo para consultas vinculadas a empresas, contratos e documentos quando necessário.",
	...
	},
	{
		...
		modules: ["Administrativo", "Notificações", "Callbacks"],
		syncFrequency: "manual",
		healthcheckPath: "/status",
		notes:
			"Usada para notificações administrativas quando associada como provedora.",
	...
	},
	{
		...
		modules: ["Administrativo", "ERP", "Documentos", "Contratos"],
		syncFrequency: "manual",
		healthcheckPath: "/status",
		notes:
			"Pré-integração administrativa preparada para conectar o Sapiens quando os endpoints oficiais forem liberados.",
	...
	{
		id: "system-adm-vps-api",
		name: "API Principal da VPS",
		provider: "Administrativo VPS",
		baseUrl: "https://adm.retiradas.tech/api",
		environment: "production",
		active: true,
		authType: "none",
		authLocation: "header",
		credentialRef: "systemd:adm-api",
		modules: ["Administrativo", "VPS"],
		syncFrequency: "manual",
	...
	},
	{
		...
		modules: ["PostgreSQL", "Administrativo"],
		syncFrequency: "manual",
		healthcheckPath: "/health",
	...
	},
	{
		...
		modules: ["Usuários", "Documentos", "Empresas", "Insumos"],
		syncFrequency: "manual",
		healthcheckPath: "/admin/api-status",
		notes:
	...
	},
	{
		...
		authLocation: "header",
		credentialRef: "",
		modules: ["Dashboard", "Agenda", "Documentos"],
		syncFrequency: "manual",
		healthcheckPath: "/public/dashboard",
		notes:
			"Valida snapshots administrativos usados por dashboard, agenda e páginas públicas do ADM.",
	...
	},
	{
		...
		authLocation: "header",
		credentialRef: "Bearer da sessao",
		modules: ["Documentos", "Imóveis", "Insumos", "Empresas"],
		syncFrequency: "manual",
		healthcheckPath: "/admin/api-status",
		notes:
			"Valida coleções alimentadas por uploads e importações administrativas.",
	...
	},
	{
		...
		modules: ["Dashboard", "Notificações", "Documentos"],
		syncFrequency: "manual",
		healthcheckPath: "/events",
		notes:
			"Valida canal Server-Sent Events usado para atualizações administrativas em tempo real.",
