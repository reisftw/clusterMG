		...
		<BudgetDropdownSection
			...
			action={
				<div className="flex flex-col gap-2 lg:flex-row lg:items-center">
					...
					{/* UX_AUDIT.md, Fase 5 (paleta de botão primário): "Nova X" é
					bg-blue-600 em todo o resto do Finan (Nova conta, Nova meta,
					Novo indicador, Novo usuário...) — este era o único em
					emerald, quebrando a convenção sem motivo semântico. */}
					<button
						type="button"
						onClick={() => setAccountModal({ account: EMPTY_FINANCIAL_ACCOUNT })}
						disabled={!canManage || saving}
						className="inline-flex min-h-10 items-center gap-2 rounded-xl bg-blue-600 px-3 text-xs font-black text-white hover:bg-blue-700 disabled:opacity-50"
					>
