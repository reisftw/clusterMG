...
export default function DocumentosConfigPage() {
	...
	const applyStatusToForm = useCallback((nextStatus) => {
		...
		setForm((current) => ({
			...
			oauthClientSecret: "",
			oauthRedirectUri:
				nextStatus?.oauthRedirectUri ||
				"https://retiradas.tech/api/documentos/google/callback",
		}));
	}, []);
					...
					<div className="flex items-center gap-4">
						...
						<div>
							...
							<p className="text-sm text-slate-500">
								Conexão do Google Drive usada para armazenar arquivos das
								empresas.
							</p>
						</div>
					</div>
				...
				>
					<div className="mb-5">
						...
						<p className="text-sm font-semibold text-slate-500">
							Esses dados ficam salvos no sistema e passam a valer como
