    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="text-lg font-bold text-gray-900">Agentes Autorizados</h2>
            <p className="text-xs text-gray-400">{agentes.length} cidade(s) com agente autorizado</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <button
      ...
      <div className="space-y-2">
        {Object.entries(porRegional).map(([nomeRegional, lista]) => {
          ...
          return (
            <div key={nomeRegional} className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              <div
              ...
              >
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  <span className="font-bold text-gray-900 tracking-wide">{nomeRegional}</span>
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-bold text-sm text-gray-900">{agente.cidade}</span>
                          </div>
                          {podeEditar && (
      ...
      {agentes.length === 0 && (
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-12 text-center">
          ...
          <p className="text-sm text-gray-400">Nenhum agente autorizado cadastrado.</p>
        </div>
      )}
