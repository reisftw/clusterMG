...
const AgendaModalContent = ({ evento, onSalvar, onClose }) => {
	...
	const toggleParticipante = (colab) => {
		setForm((f) => {
			const existe = f.participantes.some((p) => p.id === colab.id);
			return {
				...f,
				participantes: existe
					...
					: [
							...f.participantes,
							{ id: colab.id, nome: colab.nome, cargo: colab.cargo },
						],
			};
		});
	};
		...
		<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm px-4">
			<div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col border border-gray-100">
				...
				<div className="flex-1 overflow-y-auto px-6 py-5 space-y-4">
					<div>
						<label htmlFor="agenda-atividade" className="block text-xs font-semibold text-gray-600 mb-1.5">
							Atividade *
						</label>
						<input
							id="agenda-atividade"
					...
					<div>
						<label htmlFor="agenda-cidade" className="block text-xs font-semibold text-gray-600 mb-1.5">
					...
					<div className="grid grid-cols-2 gap-3">
						<div>
							<label htmlFor="agenda-data-inicio" className="block text-xs font-semibold text-gray-600 mb-1.5">
								Data Inicio *
							</label>
							<input
						...
						<div>
							<label htmlFor="agenda-data-fim" className="block text-xs font-semibold text-gray-600 mb-1.5">
								Data Fim
							</label>
							<input
								id="agenda-data-fim"
					...
					<div>
						<label htmlFor="agenda-descricao" className="block text-xs font-semibold text-gray-600 mb-1.5">
							Descricao
						</label>
						<textarea
							id="agenda-descricao"
