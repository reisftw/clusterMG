...
const AgendaPage = () => {
  ...
  const listaFiltrada = useMemo(() => {
    ...
    return eventos.filter((e) => {
      ...
      const periodoOk =
        filtro === 'proximos' ? fim >= hoje : filtro === 'passados' ? fim < hoje : true;
      const textoOk = !termo
        ? true
      ...
      const cidadeOk = filtroCidade === 'todas' ? true : e.cidade === filtroCidade;
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-4 flex-wrap">
                      ...
                      {evento.participantes?.length > 0 && (
                        <span className="flex items-center gap-1 text-xs text-gray-400">
                          <Users size={11} /> {evento.participantes.length} pessoa(s)
                        </span>
                      )}
                    </div>
