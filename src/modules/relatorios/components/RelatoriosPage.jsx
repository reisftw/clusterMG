		...
		<div className="space-y-6">
				...
				<div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
					<div className="max-w-3xl">
						...
						<p className="mt-2 text-sm leading-6 text-white/80">
							Reunimos os principais relatórios operacionais para exportar em
							PDF ou XLSX: técnicos, regionais, entregas do mês, agentes
							autorizados, match e mapa.
						</p>
					</div>
			...
			<section className="grid gap-5 xl:grid-cols-2">
				<ReportCard
					...
					loadingKey="tecnicos"
					onPdf={() =>
						runExport("tecnicos:pdf", () =>
							exportTecnicosPdf(mesSelecionado, dadosMes),
						)
					}
					onXlsx={() =>
						runExport("tecnicos:xlsx", () =>
							exportTecnicosXlsx(mesSelecionado, dadosMes),
						)
					}
				/>
				...
				<ReportCard
					...
					onPdf={() =>
						runExport("regionais:pdf", () =>
							exportRegionaisPdf(mesSelecionado, dadosMes),
						)
					}
					onXlsx={() =>
						runExport("regionais:xlsx", () =>
							exportRegionaisXlsx(mesSelecionado, dadosMes),
						)
					}
				/>
				...
				<ReportCard
					...
					loadingKey="entregas"
					onPdf={() =>
						runExport("entregas:pdf", () =>
							exportEntregaMesPdf(mesSelecionado, dadosMes),
						)
					}
					onXlsx={() =>
						runExport("entregas:xlsx", () =>
							exportEntregaMesXlsx(mesSelecionado, dadosMes),
						)
					}
				/>
				...
				<ReportCard
					...
					loadingKey="agentes"
					onPdf={() =>
						runExport("agentes:pdf", () =>
							exportAgentesPdf(mesSelecionado, dadosAgentesMes),
						)
					}
					onXlsx={() =>
						runExport("agentes:xlsx", () =>
							exportAgentesXlsx(mesSelecionado, dadosAgentesMes),
						)
					}
				/>
				...
				<ReportCard
					...
					onPdf={() =>
						runExport("mapa:pdf", () =>
							exportMapaPdf(mapa.ordens, mapa.ultimaAtualizacao),
						)
					}
					onXlsx={() =>
				...
				<ReportCard
					...
					onPdf={() =>
						runExport("match:pdf", () =>
							exportMatchPdf(match.ordens, match.ultimaAtualizacao),
						)
					}
					onXlsx={() =>
			...
			<section className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 px-5 py-4 text-sm leading-6 text-slate-500">
				Os relatórios de técnicos, regionais, entregas do mês e agentes
				autorizados usam o mês selecionado acima. Já os relatórios de mapa e
				match exportam a fotografia mais recente disponível no sistema.
			</section>
		</div>
	);
}
