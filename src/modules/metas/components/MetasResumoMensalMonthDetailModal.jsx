				...
				<div className="space-y-6 px-6 py-6">
					...
					>
						...
						<p className="mt-2 text-sm text-gray-700">
							...
							sobre {detail.cancelamentos.toLocaleString("pt-BR")}{" "}
							cancelamentos.
							{detail.metaBrasilTecpar.atingiu ? (
								<>
									{" "}
								...
								<>
									...
									Faltam{" "}
									<strong>
										{detail.metaBrasilTecpar.falta.toLocaleString("pt-BR")}{" "}
										retiradas
									</strong>{" "}
					...
					>
						...
						{!detail.atingiu && (
							<p className="mt-4 text-sm text-gray-700">
								Para atingir a{" "}
								{String(detail.metaModeLabel || "meta sazonal").toLowerCase()}{" "}
								de {detail.metaSazonal}%, o mes precisaria de{" "}
								<strong>
									{detail.faltaOS.toLocaleString("pt-BR")} retiradas a mais
								</strong>
							...
							<div className="mt-4 space-y-3">
								{detail.regionaisAbaixo.length > 0 ? (
									...
									<div className="rounded-2xl bg-green-50 p-4 text-sm font-semibold text-green-700">
										Todas as regionais ficaram dentro ou acima da referencia
										individual.
									</div>
								)}
							</div>
