...
const Badge = ({ v }) => {
  ...
  return (
    <span className={`inline-block px-2 py-0.5 rounded-lg text-xs font-bold border ${cls}`}>
      {v > 0 ? `+${v}` : v}
    </span>
  );
};
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
      <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between flex-wrap gap-2">
        <h3 className="text-sm font-bold text-gray-800">Saldo Diario — Meta por Dia</h3>
        <div className="flex items-center gap-3 text-xs text-gray-500">
          ...
          <span>
            Saldo mes:{" "}
            <strong className={lastSaldo >= 0 ? "text-green-600" : "text-red-500"}>
        ...
        <table className="min-w-[680px] w-full text-sm">
          ...
          <tbody>
            {sd.map((row) => (
              ...
              >
                <td className="px-3 py-2.5 text-center font-bold text-gray-700">{row.dia}</td>
                <td className="px-3 py-2.5 text-center text-gray-600">{row.equipe}</td>
                <td className="px-3 py-2.5 text-center text-gray-600">{row.agente}</td>
                <td className="px-3 py-2.5 text-center text-gray-600">{row.loja}</td>
                <td className="px-3 py-2.5 text-center text-gray-600">{row.regionais}</td>
                <td className="px-3 py-2.5 text-center font-bold text-gray-800">{row.totalDia}</td>
                <td className="px-3 py-2.5 text-center text-blue-600 font-semibold">{row.metaDia}</td>
            ...
            <tr className="bg-blue-50 border-t border-blue-100 font-bold">
              <td className="px-3 py-3 text-center text-blue-700 text-xs uppercase">Total</td>
              <td className="px-3 py-3 text-center text-blue-700">{totEquipe}</td>
              <td className="px-3 py-3 text-center text-blue-700">{totAgente}</td>
              <td className="px-3 py-3 text-center text-blue-700">{totLoja}</td>
              <td className="px-3 py-3 text-center text-blue-700">{totRegionais}</td>
