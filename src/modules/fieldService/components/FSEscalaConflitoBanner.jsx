...
const FSEscalaConflitoBanner = ({ mensagem, onContinuar, onCancelar }) => (
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm px-4">
    <div className="bg-white rounded-2xl shadow-2xl border border-orange-200 w-full max-w-md overflow-hidden">
      <div className="bg-gradient-to-r from-orange-500 to-orange-600 px-6 py-4 flex items-center gap-3">
        ...
        <div>
          <p className="font-bold text-white">Conflito de Escala</p>
      ...
      <div className="p-6">
        ...
        <p className="text-gray-500 text-xs bg-orange-50 border border-orange-100 rounded-xl px-4 py-3">
          Você pode salvar mesmo assim, mas revise com o gestor responsável pela
          regional.
        </p>
      </div>
      <div className="flex gap-3 px-6 pb-6">
        ...
        >
          <AlertTriangle size={15} /> Ciente, salvar
        </button>
      </div>
    </div>
  </div>
...
export default FSEscalaConflitoBanner;
