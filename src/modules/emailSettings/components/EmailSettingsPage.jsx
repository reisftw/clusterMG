...
const EmailSettingsPage = () => {
  ...
  const test = async () => {
    ...
    try {
      ...
      setFeedback(`${response?.sent || templateKeys.length} e-mails de teste enviados para ${testTo}.`);
      ...
      <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-black text-slate-950">E-mail do Sistema</h1>
      ...
      {activeTab === "logs" ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full min-w-[920px] text-sm">
                <thead className="border-b border-slate-200 bg-slate-50">
                  <tr>
                    <th className="px-4 py-3 text-left font-black text-slate-600">Data</th>
                    <th className="px-4 py-3 text-left font-black text-slate-600">Tipo</th>
                    <th className="px-4 py-3 text-left font-black text-slate-600">Destinatário</th>
                    <th className="px-4 py-3 text-left font-black text-slate-600">Assunto</th>
                    <th className="px-4 py-3 text-left font-black text-slate-600">Status</th>
                    <th className="px-4 py-3 text-left font-black text-slate-600">Motivo do erro</th>
                  </tr>
                </thead>
                  ...
                  {logsLoading ? (
                    ...
                    logs.map((item) => (
                      <tr key={item.id} className="hover:bg-slate-50">
                        <td className="px-4 py-3 font-semibold text-slate-700">{formatDateTime(item.createdAt)}</td>
        ...
        <>
          ...
          <section className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_380px]">
            <div className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <div className="mt-5 grid gap-4 md:grid-cols-2">
                ...
                <label>
                  ...
                  <input type="number" className={inputClass} value={config.smtpPort || 465} onChange={(e) => update("smtpPort", e.target.value)} />
                </label>
                <label>
              ...
              <h2 className="mt-8 text-lg font-black text-slate-950">MFA por e-mail</h2>
              <div className="mt-5 grid gap-4 md:grid-cols-2">
              ...
              <h2 className="mt-8 text-lg font-black text-slate-950">Identidade</h2>
              <div className="mt-5 grid gap-4 md:grid-cols-2">
                <label>
            ...
            <div className="rounded-lg border border-blue-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-2 text-sm font-medium text-slate-500">
                Envie uma prévia real de todos os templates para validar autenticação, remetente e layout.
              </p>
              ...
              <div className="mt-5 rounded-lg border border-slate-200 bg-slate-50 p-4 text-sm font-semibold leading-relaxed text-slate-600">
                Os e-mails de criação de conta, redefinição e MFA usam tokens/códigos temporários.
              </div>
            </div>
          </section>
          ...
          <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex flex-col gap-2 lg:flex-row lg:items-end lg:justify-between">
              <div>
                <h2 className="text-lg font-black text-slate-950">Templates dos e-mails</h2>
                <p className="mt-1 text-sm font-medium text-slate-500">
              ...
              <div className="rounded-lg border border-blue-100 bg-blue-50 px-3 py-2 text-xs font-bold leading-relaxed text-blue-800">
                Variáveis: {"{nome}"}, {"{email}"}, {"{role}"}, {"{regional}"}, {"{resetUrl}"}, {"{appUrl}"}, {"{codigo}"}, {"{minutos}"}
              </div>
            </div>
