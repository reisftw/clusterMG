			...
			{activeTab === "logs" ? (
				<section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
					...
					<div className="mt-4 flex flex-col gap-3 text-sm font-semibold text-slate-500 sm:flex-row sm:items-center sm:justify-between">
						<span>
							Mostrando{" "}
							{logs.length ? (logsPage - 1) * EMAIL_LOG_PAGE_SIZE + 1 : 0} a{" "}
							{Math.min(logsPage * EMAIL_LOG_PAGE_SIZE, logsTotal)} de{" "}
							{logsTotal}
						</span>
						<div className="flex items-center gap-2">
							...
							<button
								...
								disabled={
									logsPage * EMAIL_LOG_PAGE_SIZE >= logsTotal || logsLoading
								}
								className="rounded-lg border border-slate-300 px-3 py-2 font-bold text-slate-700 disabled:opacity-40"
							>
								Próxima
							...
							<div className="mt-5 grid gap-4 md:grid-cols-2">
								...
								>
									<input
										...
										onChange={(e) =>
											update("mfaEmailEnabled", e.target.checked)
										}
										className="h-5 w-5 rounded border-slate-300 text-blue-600"
									/>
									<span>
								...
								<label>
									...
									<input
										...
										onChange={(e) =>
											update("mfaEmailTtlMinutes", e.target.value)
										}
									/>
								</label>
							</div>
					...
					<section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
						<div className="flex flex-col gap-2 lg:flex-row lg:items-end lg:justify-between">
							<div>
								...
								<p className="mt-1 text-sm font-medium text-slate-500">
									Edite o texto enviado em cada ação do sistema. As variáveis
						...
						<div className="mt-5 grid gap-4 md:grid-cols-2">
							...
							<label>
								...
								<input
									...
									onChange={(e) =>
										updateTemplate("actionLabel", e.target.value)
									}
