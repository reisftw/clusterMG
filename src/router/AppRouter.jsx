...
const Dashboard = lazy(() => import("../modules/dashboard/components/DashboardPage"));
...
const TecnicosBolsaAuditoria = lazy(() =>
  import("../modules/tecnicosAuditoria/components/TecnicosBolsaAuditoriaPage"),
);
const TecnicosAuditoriaRelatorios = lazy(() =>
  import("../modules/tecnicosAuditoria/components/TecnicosAuditoriaRelatoriosPage"),
);
...
const Regionais = lazy(() => import("../modules/regionais/components/RegionaisPage"));
const Agentes = lazy(() => import("../modules/regionais/components/AgentesPage"));
...
const GestaoDuvidas = lazy(() => import("../modules/duvidas/components/DuvidasPage"));
const Feriados = lazy(() => import("../modules/feriados/components/FeriadosPage"));
...
const PainelPublico = lazy(() => import("../pages/PainelPublico/PainelPublico"));
...
const MapaPublicoPage = lazy(() => import("../pages/PainelPublico/MapaPublicoPage"));
const MatchPublicoPage = lazy(() => import("../pages/PainelPublico/MatchPublicoPage"));
...
const TerceirosHomePage = lazy(() => import("../pages/Terceiros/TerceirosHomePage"));
...
const Retiradas = lazy(() => import("../modules/retiradas/components/RetiradasPage"));
...
const InsumosAdministrativos = lazy(() =>
  import("../modules/insumosAdministrativos/components/InsumosAdministrativosPage"),
);
const InsumosRequisicoes = lazy(() =>
  import("../modules/insumosAdministrativos/components/InsumosRequisicoesPage"),
);
const ImoveisAdministrativos = lazy(() =>
  import("../modules/imoveisAdministrativos/components/ImoveisAdministrativosPage"),
);
  ...
  <BrowserRouter>
    <Suspense fallback={<Spinner fullScreen />}>
      <Routes>
        ...
        <Route path={ROUTES.TERCEIRIZADOS} element={<TerceirosHomePage portal="terceirizados" />} />
        <Route
        ...
        <Route element={<AuthenticatedRoutes />}>
          ...
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["view_agendamentos", "cliente.agendamentos.view", "cliente.agendamentos.manage"]}>
                <Acompanhamento />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["view_acerto_estoque", "estoque.acerto_estoque.view", "estoque.acerto_estoque.manage"]}>
                <AcertoEstoque />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["view_estoque_integrado", "estoque.equipamentos.view", "estoque.equipamentos.manage"]}>
                <EstoqueIntegrado />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["view_estoque_integrado", "tecnicos.bolsa_tecnico.view", "tecnicos.bolsa_tecnico.manage"]}>
                <BolsaTecnico />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["tecnicos.auditoria_bolsa.view", "tecnicos.auditoria_bolsa.manage"]}>
          ...
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["view_estoque_integrado", "estoque.consulta.view"]}>
                <EstoqueConsulta />
              </ProtectedRoute>
            }
          />
          <Route
            path={ROUTES.DIARIO}
            element={
              <ProtectedRoute requiredPermission={["view_diario", "destaque.diario.view", "destaque.diario.manage"]}>
                <Diario />
              </ProtectedRoute>
            }
          />
          <Route
            path={ROUTES.MAPA}
            element={
              <ProtectedRoute requiredPermission={["view_mapa", "destaque.mapa_os.view"]}>
                <Mapa />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["view_entregas_tecnicos", "tecnicos.entrega_tecnicos.view", "tecnicos.entrega_tecnicos.manage"]}>
                <EntregasTecnicos />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["view_logistica", "logistica.logistica.view", "logistica.logistica.manage"]}>
                <Logistica />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["financeiro.visao_geral.view", "financeiro.visao_geral.manage"]}>
          ...
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["financeiro.contas_pagar.view", "financeiro.contas_pagar.manage"]}>
          ...
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["financeiro.contas_receber.view", "financeiro.contas_receber.manage"]}>
          ...
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["financeiro.configuracoes.view", "financeiro.configuracoes.manage"]}>
          ...
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["view_integracoes", "configuracao.integracoes.view", "configuracao.integracoes.manage"]}>
                <Integracoes />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["manage_mensageria", "mensageria.email_config.view", "mensageria.email_config.manage"]}>
                <Mensageria />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["manage_mensageria", "mensageria.api.view", "mensageria.api.manage"]}>
                <MensageriaApi />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["manage_mensageria", "mensageria.fila.view", "mensageria.fila.manage"]}>
                <MensageriaFila />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["view_mensageria", "mensageria.enviados.view"]}>
                <MensageriaEnviados />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["view_mensageria_relatorios", "mensageria.relatorios.view"]}>
          ...
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["view_confirmacao_agendamentos", "mensageria.confirmacao_agendamentos.view", "mensageria.confirmacao_agendamentos.manage"]}>
          ...
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["view_mensageria", "mensageria.backlog.view", "mensageria.backlog.manage"]}>
                <MensageriaBacklog />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["manage_mensageria", "mensageria.callback.view", "mensageria.callback.manage"]}>
                <MensageriaCallback />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["manage_general_settings", "configuracao.geral.view", "configuracao.geral.manage"]}>
                <ConfiguracoesGerais />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["manage_api_status", "configuracao.apis.view", "configuracao.apis.manage"]}>
                <ApiStatus />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["manage_integracoes", "configuracao.hubsoft.view", "configuracao.hubsoft.manage"]}>
                <HubsoftSettings />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["manage_integracoes", "configuracao.cvortex.view", "configuracao.cvortex.manage"]}>
                <CvortexSettings />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["manage_integracoes", "configuracao.senior.view", "configuracao.senior.manage"]}>
                <SeniorSettings />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["manage_database_backups", "configuracao.banco_dados.view", "configuracao.banco_dados.manage"]}>
                <DatabaseBackups />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["manage_email", "configuracao.email.view", "configuracao.email.manage"]}>
                <EmailSettings />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["view_empresas_tecnicos", "empresas.cadastro.view", "empresas.cadastro.manage"]}>
                <EmpresasTecnicos />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["view_documentos", "administrativo.documentos.view", "administrativo.documentos.manage"]}>
          ...
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["view_documentos_tratativas", "administrativo.documentos.view", "administrativo.documentos.manage"]}>
          ...
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["manage_documentos", "administrativo.documentos.manage"]}>
                <DocumentosConfig />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["view_documentos_relatorios", "administrativo.relatorios.view"]}>
          ...
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["view_insumos_administrativos", "administrativo.insumos.view", "administrativo.insumos.manage"]}>
          ...
          />
            <Route
              ...
              element={
                <ProtectedRoute requiredPermission={["view_imoveis_administrativos", "administrativo.imoveis.view", "administrativo.imoveis.manage"]}>
          ...
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["manage_colaboradores", "equipe.colaboradores.view", "equipe.colaboradores.manage"]}>
                <Colaboradores />
              </ProtectedRoute>
            }
          />
          <Route
            path={ROUTES.FERIAS}
            element={
              <ProtectedRoute requiredPermission={["request_ferias", "equipe.ferias.view", "equipe.ferias.manage"]}>
                <Ferias />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["view_regionais", "configuracao.regionais.view", "configuracao.regionais.manage"]}>
                <Regionais />
              </ProtectedRoute>
            }
          />
          <Route
            path={ROUTES.AGENTES}
            element={
              <ProtectedRoute requiredPermission={["view_agentes", "configuracao.agentes.view", "configuracao.agentes.manage"]}>
                <Agentes />
              </ProtectedRoute>
            }
          />
          <Route
            path={ROUTES.AGENDA}
            element={
              <ProtectedRoute requiredPermission={["view_agenda", "equipe.agenda.view", "equipe.agenda.manage"]}>
                <Agenda />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["manage_feriados", "equipe.feriados.view", "equipe.feriados.manage"]}>
                <Feriados />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["manage_users", "configuracao.usuarios.view", "configuracao.usuarios.manage"]}>
                <Usuarios />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["manage_roles", "configuracao.cargos_permissoes.view", "configuracao.cargos_permissoes.manage"]}>
                <CargosPermissoes />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute requiredPermission={["manage_general_settings", "configuracao.notificacoes.view", "configuracao.notificacoes.manage"]}>
                <Notificacoes />
              </ProtectedRoute>
            }
          />
          <Route
            path={ROUTES.METAS}
            element={
              <ProtectedRoute requiredPermission={["view_metas", "destaque.metas.view", "destaque.metas.manage"]}>
                <Metas />
              </ProtectedRoute>
            }
          />
