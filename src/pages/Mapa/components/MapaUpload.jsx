...
import { Upload, X, Calendar, HelpCircle } from "lucide-react";
      ...
      <div className="fixed inset-0 z-layout-modal flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6">
          ...
          <p className="text-xs text-gray-500 mb-4">
            ...
            {quantidadeArquivos > 1 ? ` Arquivos selecionados: ${quantidadeArquivos}.` : ""}
          </p>
          <div className="mb-5">
  ...
  const renderCampos = (items, tone = "blue") => (
    <div className="overflow-hidden rounded-xl border border-gray-200">
      {items.map(([campo, descricao]) => (
        ...
        >
          <code className={`text-xs font-semibold ${tone === "green" ? "text-emerald-700" : "text-blue-700"}`}>
            {campo}
          </code>
      ...
      <div className="fixed inset-0 z-layout-modal flex items-center justify-center p-4">
        ...
        >
          <div className="mb-5 flex items-start justify-between gap-3">
            <div>
              <h3 id="mapa-fields-help-title" className="font-bold text-gray-900">
          ...
          <p className="mt-4 text-xs leading-5 text-gray-500">
            O sistema também aceita alguns nomes equivalentes, como <strong>num_os</strong>,
            <strong> telefone</strong>, <strong>whatsapp</strong>, <strong>cliente</strong> e
...
export default function MapaUpload({ onConcluido }) {
  ...
  async function handleConfirmar(periodo) {
    ...
    try {
      const res = await processarUploadMapa(filesPendentes, setProgresso, periodo, setJobStatus);
      setResultado(res);
    ...
    <div className="flex flex-col gap-3">
      <div className="flex items-center gap-4 flex-wrap bg-white border border-gray-200 rounded-2xl p-4 shadow-sm">
        ...
        <StaticDataRefreshLink
          className="flex items-center gap-2 px-4 py-2 bg-white border border-blue-200 hover:border-blue-300 hover:bg-blue-50 text-blue-700 text-sm font-semibold rounded-xl transition-all"
        />
