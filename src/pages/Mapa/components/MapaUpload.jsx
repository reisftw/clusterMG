      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6">
          ...
          <p className="text-xs text-gray-500 mb-4">
            Informe o periodo que foi filtrado na planilha antes de importar.
          </p>
...
export default function MapaUpload({ onConcluido }) {
  ...
  async function handleConfirmar(periodo) {
    ...
    try {
      const res = await processarUploadMapa(filePendente, setProgresso, periodo);
      setResultado(res);
