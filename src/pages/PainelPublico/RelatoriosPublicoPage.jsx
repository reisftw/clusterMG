...
export default function RelatoriosPublicoPage() {
	...
	const pageLoading =
		loading || retiradas.loading || agentes.loading || match.loading;
					...
					<div className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
						<div className="max-w-3xl">
							...
							<p className="mt-3 text-sm leading-6 text-slate-600">
								Baixe os principais relatórios do painel em PDF ou XLSX usando
								os dados públicos mais recentes disponíveis.
							</p>
						</div>
					...
					<>
						...
						<section className="grid gap-6 xl:grid-cols-2">
							<ReportCard
								...
								onPdf={() =>
									runExport("tecnicos-publico:pdf", () =>
										exportTecnicosPdf(month, dadosMes),
									)
								}
								onXlsx={() =>
									runExport("tecnicos-publico:xlsx", () =>
										exportTecnicosXlsx(month, dadosMes),
									)
								}
							/>
							...
							<ReportCard
								...
								onPdf={() =>
									runExport("regionais-publico:pdf", () =>
										exportRegionaisPdf(month, dadosMes),
									)
								}
								onXlsx={() =>
									runExport("regionais-publico:xlsx", () =>
										exportRegionaisXlsx(month, dadosMes),
									)
								}
							/>
							...
							<ReportCard
								...
								onPdf={() =>
									runExport("entregas-publico:pdf", () =>
										exportEntregaMesPdf(month, dadosMes),
									)
								}
								onXlsx={() =>
									runExport("entregas-publico:xlsx", () =>
										exportEntregaMesXlsx(month, dadosMes),
									)
								}
							/>
							...
							<ReportCard
								...
								onPdf={() =>
									runExport("agentes-publico:pdf", () =>
										exportAgentesPdf(month, dadosAgentesMes),
									)
								}
								onXlsx={() =>
									runExport("agentes-publico:xlsx", () =>
										exportAgentesXlsx(month, dadosAgentesMes),
									)
								}
							/>
							...
							<ReportCard
								...
								onPdf={() =>
									runExport("match-publico:pdf", () =>
										exportMatchPdf(matchOrdens, matchMeta),
									)
								}
								onXlsx={() =>
									runExport("match-publico:xlsx", () =>
										exportMatchXlsx(matchOrdens),
									)
								}
							/>
						</section>
