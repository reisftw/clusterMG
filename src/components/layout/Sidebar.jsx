...
const NAV_ITEMS = [
  {
    ...
    icon: Boxes,
    permission: ["view_acerto_estoque", "estoque.acerto_estoque.view", "estoque.acerto_estoque.manage"],
  },
  {
    label: "Equipamentos",
    path: ROUTES.ESTOQUE_EQUIPAMENTOS,
    icon: PackageSearch,
    permission: ["view_estoque_integrado", "estoque.equipamentos.view", "estoque.equipamentos.manage"],
  },
  {
    label: "Bolsa Técnico",
    path: ROUTES.TECNICOS_AUDITORIA_BOLSA,
    icon: PackageSearch,
    permission: ["tecnicos.auditoria_bolsa.view", "tecnicos.auditoria_bolsa.manage"],
  },
  {
    label: "Relatórios",
  ...
  },
  {
    ...
    path: ROUTES.DIARIO,
    icon: ClipboardList,
    permission: ["view_diario", "destaque.diario.view", "destaque.diario.manage"],
    featured: true,
  },
  {
    label: "Mapa O.S",
  ...
  },
  {
    ...
    icon: UserSquare2,
    permission: ["manage_colaboradores", "equipe.colaboradores.view", "equipe.colaboradores.manage"],
  },
  {
    label: "Férias",
    path: ROUTES.FERIAS,
    icon: CalendarDays,
    permission: ["request_ferias", "equipe.ferias.view", "equipe.ferias.manage"],
  },
  {
    label: "Regionais",
    path: ROUTES.REGIONAIS,
    icon: MapPin,
    permission: ["view_regionais", "configuracao.regionais.view", "configuracao.regionais.manage"],
  },
  {
    label: "Agentes",
    path: ROUTES.AGENTES,
    icon: Star,
    permission: ["view_agentes", "configuracao.agentes.view", "configuracao.agentes.manage"],
  },
  {
  ...
  },
  {
    ...
    icon: CalendarClock,
    permission: ["view_agendamentos", "cliente.agendamentos.view", "cliente.agendamentos.manage"],
    featured: true,
  },
  {
    label: "Entrega",
    ...
    icon: PackageCheck,
    permission: ["view_entregas_tecnicos", "tecnicos.entrega_tecnicos.view", "tecnicos.entrega_tecnicos.manage"],
  },
  {
    label: "Logística",
    path: ROUTES.LOGISTICA,
    icon: Truck,
    permission: ["view_logistica", "logistica.logistica.view", "logistica.logistica.manage"],
  },
  {
    label: "Visão Geral",
    path: ROUTES.FINANCEIRO,
    icon: BadgeDollarSign,
    permission: ["financeiro.visao_geral.view", "financeiro.visao_geral.manage"],
  },
  {
    label: "Contas a Pagar",
    path: ROUTES.FINANCEIRO_CONTAS_PAGAR,
    icon: ClipboardList,
    permission: ["financeiro.contas_pagar.view", "financeiro.contas_pagar.manage"],
  },
  {
    label: "Contas a Receber",
    path: ROUTES.FINANCEIRO_CONTAS_RECEBER,
    icon: PackageCheck,
    permission: ["financeiro.contas_receber.view", "financeiro.contas_receber.manage"],
  },
  {
    label: "Faturamento",
  ...
  },
  {
    ...
    icon: Settings,
    permission: ["financeiro.configuracoes.view", "financeiro.configuracoes.manage"],
  },
  {
    label: "Feriados",
    path: ROUTES.FERIADOS,
    icon: CalendarCheck,
    permission: ["manage_feriados", "equipe.feriados.view", "equipe.feriados.manage"],
  },
  {
    label: "Usuários",
    path: ROUTES.USUARIOS,
    icon: Users,
    permission: ["manage_users", "configuracao.usuarios.view", "configuracao.usuarios.manage"],
  },
  {
    label: "Cargos e Permissões",
    path: ROUTES.CARGOS_PERMISSOES,
    icon: ShieldCheck,
    permission: ["manage_roles", "configuracao.cargos_permissoes.view", "configuracao.cargos_permissoes.manage"],
  },
  {
    label: "Integrações",
    path: ROUTES.INTEGRACOES,
    icon: Plug,
    permission: ["view_integracoes", "configuracao.integracoes.view", "configuracao.integracoes.manage"],
  },
  {
    label: "Configurações de Envio",
    path: ROUTES.MENSAGERIA,
    icon: MessageCircle,
    permission: ["manage_mensageria", "mensageria.email_config.view", "mensageria.email_config.manage"],
  },
  {
    label: "API",
    path: ROUTES.MENSAGERIA_API,
    icon: Server,
    permission: ["manage_mensageria", "mensageria.api.view", "mensageria.api.manage"],
  },
  {
    label: "Fila",
    path: ROUTES.MENSAGERIA_FILA,
    icon: Clock,
    permission: ["manage_mensageria", "mensageria.fila.view", "mensageria.fila.manage"],
  },
  {
    label: "Enviados",
  ...
  },
  {
    ...
    icon: ShieldCheck,
    permission: ["view_confirmacao_agendamentos", "mensageria.confirmacao_agendamentos.view", "mensageria.confirmacao_agendamentos.manage"],
  },
  {
    label: "Backlog",
    path: ROUTES.MENSAGERIA_BACKLOG,
    icon: ListChecks,
    permission: ["view_mensageria", "mensageria.backlog.view", "mensageria.backlog.manage"],
  },
  {
    label: "Callback",
    path: ROUTES.MENSAGERIA_CALLBACK,
    icon: MessageCircleReply,
    permission: ["manage_mensageria", "mensageria.callback.view", "mensageria.callback.manage"],
  },
  {
    label: "Notificações",
    path: ROUTES.NOTIFICACOES,
    icon: BellRing,
    permission: ["manage_general_settings", "configuracao.notificacoes.view", "configuracao.notificacoes.manage"],
  },
  {
    label: "Geral",
    path: ROUTES.CONFIGURACOES_GERAIS,
    icon: SlidersHorizontal,
    permission: ["manage_general_settings", "configuracao.geral.view", "configuracao.geral.manage"],
  },
  {
    label: "APIs",
    path: ROUTES.API_STATUS,
    icon: Server,
    permission: ["manage_api_status", "configuracao.apis.view", "configuracao.apis.manage"],
  },
  {
    label: "Hubsoft",
    path: ROUTES.HUBSOFT_SETTINGS,
    icon: Plug,
    permission: ["manage_integracoes", "configuracao.hubsoft.view", "configuracao.hubsoft.manage"],
  },
  {
    label: "Cvortex",
    path: ROUTES.CVORTEX_SETTINGS,
    icon: MessageCircle,
    permission: ["manage_integracoes", "configuracao.cvortex.view", "configuracao.cvortex.manage"],
  },
  {
    label: "Senior / Sapiens",
    path: ROUTES.SENIOR_SETTINGS,
    icon: Database,
    permission: ["manage_integracoes", "configuracao.senior.view", "configuracao.senior.manage"],
  },
  {
    label: "Banco de Dados",
    path: ROUTES.DATABASE_BACKUPS,
    icon: Database,
    permission: ["manage_database_backups", "configuracao.banco_dados.view", "configuracao.banco_dados.manage"],
  },
  {
    label: "E-mail",
    path: ROUTES.EMAIL_SETTINGS,
    icon: Mail,
    permission: ["manage_email", "configuracao.email.view", "configuracao.email.manage"],
  },
  {
    label: "Cadastro",
    path: ROUTES.EMPRESAS_TECNICOS,
    icon: Building2,
    permission: ["view_empresas_tecnicos", "empresas.cadastro.view", "empresas.cadastro.manage"],
  },
  {
    label: "Documentos Pendentes",
    path: ROUTES.DOCUMENTOS_PENDENTES,
    icon: FileClock,
    permission: ["view_documentos", "administrativo.documentos.view", "administrativo.documentos.manage"],
  },
  {
    label: "Tratativas",
    path: ROUTES.DOCUMENTOS_TRATATIVAS,
    icon: FileClock,
    permission: ["view_documentos_tratativas", "administrativo.documentos.view", "administrativo.documentos.manage"],
  },
  {
  ...
  },
  {
    ...
    icon: BarChart3,
    permission: ["view_documentos_relatorios", "administrativo.relatorios.view"],
  },
  {
    label: "Insumos - Estoque",
    path: ROUTES.INSUMOS_ADMINISTRATIVOS,
    icon: PackagePlus,
    permission: ["view_insumos_administrativos", "administrativo.insumos.view", "administrativo.insumos.manage"],
  },
  {
  ...
  },
  {
    ...
    icon: Building2,
    permission: ["view_imoveis_administrativos", "administrativo.imoveis.view", "administrativo.imoveis.manage"],
  },
  {
...
function SidebarNavLink({ item, className, onNavigate, displayLabel, labelClass = "truncate" }) {
  const { label, path, icon: IconComponent } = item;
  return (
    <NavLink key={path} to={path} onClick={onNavigate} className={className} title={label}>
...
function SidebarSectionLabel({ children, collapsed, isModernLayout, tone = "default" }) {
  const colorClass = isModernLayout
    ...
    : tone === "blue"
      ...
      : "text-gray-400";
  return (
    <p className={`${collapsed ? "sr-only" : ""} mb-2 px-4 text-[10px] font-bold uppercase tracking-wider ${colorClass}`}>
      {children}
    </p>
  );
}
...
function FeaturedMenuItems({
  ...
  return (
    <>
      <SidebarSectionLabel collapsed={collapsed} isModernLayout={isModernLayout} tone="blue">
        Em destaque
      </SidebarSectionLabel>
      {items.map((item) => (
        <SidebarNavLink
      ...
      <div className={isModernLayout ? "my-3 border-t border-white/10" : "my-3 border-t border-gray-100"} />
    </>
  );
}
      ...
      {open ? (
        <div className={submenuWrapClass}>
          {items.map((item) => {
            ...
            return (
              <NavLink key={item.path} to={item.path} onClick={onNavigate} className={submenuClass}>
                <ChildIcon size={15} className="shrink-0" />
                <span className="truncate">{displayLabel(labelFormatter(item.label), item.path)}</span>
              </NavLink>
            );
          })}
        </div>
...
function AdministrativeGroupItems({
  ...
  const documentItems = group.items.filter((item) => ADMINISTRATIVO_DOCUMENTOS_PATHS.includes(item.path));
  const imoveisItems = group.items.filter((item) => ADMINISTRATIVO_IMOVEIS_PATHS.includes(item.path));
  const insumosItems = group.items.filter((item) => ADMINISTRATIVO_INSUMOS_PATHS.includes(item.path));
  ...
  const isActive = (items) => items.some((item) => isMenuPathActive(pathname, item));
    ...
    <>
      ...
      {directItems.map((item) => {
        ...
        return (
          <NavLink key={item.path} to={item.path} onClick={onNavigate} className={submenuClass}>
            <ChildIcon size={15} className="shrink-0" />
            <span className="truncate">{displayLabel(item.label, item.path)}</span>
          </NavLink>
        );
      })}
    </>
...
function TecnicosGroupItems({
  ...
  const auditoriaItems = group.items.filter((item) => TECNICOS_AUDITORIA_PATHS.includes(item.path));
...
function MenuGroup({
  ...
  return (
    <div key={group.id}>
      ...
      >
        <IconComponent size={16} className="shrink-0" />
        <span className={collapsed ? "sr-only" : "min-w-0 flex-1 truncate text-left"}>{group.label}</span>
        {!collapsed ? (
          <ChevronDown
            size={15}
            className={`shrink-0 transition-transform ${open ? "rotate-180" : ""}`}
...
function getNavClass({ isActive, tone, isModernLayout }) {
  if (!isModernLayout) {
    return `nav-item ${isActive ? "nav-item-active" : "nav-item-inactive"} ${
      tone === "orange" ? "text-orange-500" : tone === "blue" ? "text-blue-600" : ""
    }`;
  }
...
const Sidebar = ({ collapsed = false, onToggleCollapsed, onNavigate, variant = "desktop" }) => {
  ...
  useEffect(() => {
    ...
    obterContadoresNotificacoes()
      .then((counters) => {
        if (active) setDocumentosPendentes(Number(counters?.documentosPendentes || 0));
      })
      .catch(() => {});
    ...
    return () => {
      active = false;
      window.removeEventListener("retiradas:notification-counters", handleCounters);
    };
  }, []);
  ...
  const visibleItems = useMemo(
    () => NAV_ITEMS.filter((item) => item.publicAuthenticated ? Boolean(currentUser) : hasAnyPermission(currentUser, item.permission)),
    [currentUser],
  );
  const featuredItems = useMemo(
    () =>
      isModernLayout
        ? sortByPathOrder(
            visibleItems.filter((item) => MODERN_FEATURED_ORDER.includes(item.path)),
  ...
  const groupButtonClass = (active, open) => getGroupButtonClass({ active, open, isModernLayout });
  const submenuWrapClass = getSubmenuWrapClass(isModernLayout);
  const submenuClass = ({ isActive }) => getSubmenuClass({ isActive, isModernLayout });
  const nestedButtonClass = (active, open) => getNestedButtonClass({ active, open, isModernLayout });
  ...
  const navClass = ({ isActive }, tone = "default") => getNavClass({ isActive, tone, isModernLayout });
  ...
  return (
    ...
    >
      ...
      >
        {isModernLayout ? (
          <div className={collapsed ? "flex flex-col items-center gap-3" : ""}>
            ...
            />
            <p className={`${collapsed ? "sr-only" : "mt-5"} text-xs font-semibold text-slate-300`}>
              Gestão Retiradas
            </p>
          <button
            type="button"
            ...
            title={isMobileDrawer ? "Fechar menu" : collapsed ? "Expandir menu" : "Ocultar menu"}
            aria-label={isMobileDrawer ? "Fechar menu" : collapsed ? "Expandir menu" : "Ocultar menu"}
          >
      ...
      >
        ...
        <SidebarSectionLabel collapsed={collapsed} isModernLayout={isModernLayout}>
          Menu
        </SidebarSectionLabel>
        ...
        {otherMenuItems.map(({ label, path, icon: IconComponent }) => (
          <NavLink key={path} to={path} onClick={handleNavigation} className={navClass} title={label}>
            <IconComponent size={16} className="shrink-0" />
