...
function ModalHarness() {
  ...
  return (
    <div>
      ...
      <ModalShell title="Modal de teste" open={open} onClose={() => setOpen(false)}>
...
describe("ModalShell", () => {
  it("prende o foco, fecha com Escape e devolve o foco ao gatilho", async () => {
    ...
    const firstButton = await screen.findByRole("button", { name: /primeiro/i });
  ...
  it("fecha ao clicar no backdrop", async () => {
    ...
    const dialog = await screen.findByRole("dialog", { name: /modal de teste/i });
