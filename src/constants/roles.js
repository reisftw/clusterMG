...
export const PERMISSION_LABELS = Object.freeze({
	...
	"financeiro.equipe.view": "Financeiro - Equipe",
	"financeiro.equipe.manage": "Gerenciar Equipe Financeira",
...
const CATALOG_TO_LEGACY_PERMISSION = Object.freeze({
	...
	"financeiro.equipe.view": null,
	"financeiro.equipe.manage": null,
...
const LEGACY_ROLE_PERMISSIONS = Object.freeze({
	...
	"financeiro.equipe.view": ADMIN_ONLY,
	"financeiro.equipe.manage": ADMIN_ONLY,
	"atendimento.casos.view": [
		ROLES.ADMIN,
		ROLES.SUPERVISOR,
		ROLES.BACKOFFICE,
